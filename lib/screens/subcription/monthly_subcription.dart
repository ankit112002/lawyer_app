        ...
        children: [
          ...
          Column(
            children: [
              ...
              SizedBox(height: 30,),
              Center(
                child: Image.asset("assets/images/Frame 427320841.png"),
              ),
              SizedBox(height: 80,),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Text("Privacy Policy",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Color(0XFFB3BBC0)),),
                  Text("Terms and Conditions",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Color(0XFFB3BBC0)))
                ],
              )
            ],
          ),
        ...
        floatingActionButton: SizedBox(
          ...
          child: Container(
            ...
            child: FloatingActionButton.extended(
              ...
              label: Text(
                currentPage == pages.length - 1 ? "Begin" : "Get your free trial now",
